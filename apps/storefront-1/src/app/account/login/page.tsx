      ...
      <form action={showCode ? verAction : reqAction} className="mt-8 space-y-4">
        ...
        {showCode && (
          <button
            ...
            className="flex h-11 w-full items-center justify-center text-xs font-semibold text-foreground/60 underline decoration-dashed underline-offset-2 hover:text-cherry"
          >
            Resend code
          </button>
        )}
